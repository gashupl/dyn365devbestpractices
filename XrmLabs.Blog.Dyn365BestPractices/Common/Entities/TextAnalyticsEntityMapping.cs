...
namespace Common.Entities
{
	...
	public partial class TextAnalyticsEntityMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Common.Entities.AdvancedSimilarityRule advancedsimilarityrule_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.AdvancedSimilarityRule>("advancedsimilarityrule_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("advancedsimilarityrule_textanalyticsentitymapping");
				this.SetRelatedEntity<Common.Entities.AdvancedSimilarityRule>("advancedsimilarityrule_textanalyticsentitymapping", null, value);
		...
		public Common.Entities.KnowledgeSearchModel knowledgesearchmodel_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.KnowledgeSearchModel>("knowledgesearchmodel_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgesearchmodel_textanalyticsentitymapping");
				this.SetRelatedEntity<Common.Entities.KnowledgeSearchModel>("knowledgesearchmodel_textanalyticsentitymapping", null, value);
		...
		public Common.Entities.Organization organization_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.Organization>("organization_textanalyticsentitymapping", null);
			}
		}
		...
		public Common.Entities.TopicModelConfiguration topicmodelconfiguration_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.TopicModelConfiguration>("topicmodelconfiguration_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("topicmodelconfiguration_textanalyticsentitymapping");
				this.SetRelatedEntity<Common.Entities.TopicModelConfiguration>("topicmodelconfiguration_textanalyticsentitymapping", null, value);
