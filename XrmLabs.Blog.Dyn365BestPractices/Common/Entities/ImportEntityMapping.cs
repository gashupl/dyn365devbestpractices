...
namespace Common.Entities
{
	...
	public partial class ImportEntityMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Common.Entities.ImportEntityMappingState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Common.Entities.ImportEntityMappingState)(System.Enum.ToObject(typeof(Common.Entities.ImportEntityMappingState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.UserEntityInstanceData> userentityinstancedata_importentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_importentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_importentitymapping");
				this.SetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_importentitymapping", null, value);
		...
		public Common.Entities.ImportMap ImportEntityMapping_ImportMap
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.ImportMap>("ImportEntityMapping_ImportMap", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ImportEntityMapping_ImportMap");
				this.SetRelatedEntity<Common.Entities.ImportMap>("ImportEntityMapping_ImportMap", null, value);
		...
		public Common.Entities.SystemUser lk_importentitymapping_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_importentitymapping_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_importentitymapping_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_importentitymapping_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_importentitymapping_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_importentitymapping_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_importentitymapping_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_importentitymapping_modifiedby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_importentitymapping_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_importentitymapping_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_importentitymapping_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_importentitymapping_modifiedonbehalfby", null, value);
