...
namespace Common.Entities
{
	...
	public partial class TimeZoneRule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.UserEntityInstanceData> userentityinstancedata_timezonerule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_timezonerule", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_timezonerule");
				this.SetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_timezonerule", null, value);
		...
		public Common.Entities.SystemUser lk_timezonerule_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_timezonerule_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_timezonerule_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_timezonerule_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_timezonerule_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_timezonerule_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_timezonerule_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_timezonerule_modifiedby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_timezonerule_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_timezonerule_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_timezonerule_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_timezonerule_modifiedonbehalfby", null, value);
		...
		public Common.Entities.TimeZoneDefinition lk_timezonerule_timezonedefinitionid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.TimeZoneDefinition>("lk_timezonerule_timezonedefinitionid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_timezonerule_timezonedefinitionid");
				this.SetRelatedEntity<Common.Entities.TimeZoneDefinition>("lk_timezonerule_timezonedefinitionid", null, value);
