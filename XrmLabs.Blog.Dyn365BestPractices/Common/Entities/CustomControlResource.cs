...
namespace Common.Entities
{
	...
	public partial class CustomControlResource : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Common.Entities.CustomControl customcontrol_resource_id
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.CustomControl>("customcontrol_resource_id", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("customcontrol_resource_id");
				this.SetRelatedEntity<Common.Entities.CustomControl>("customcontrol_resource_id", null, value);
		...
		public Common.Entities.Organization customcontrolresource_organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.Organization>("customcontrolresource_organization", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_customcontrolresource_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_customcontrolresource_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_customcontrolresource_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_customcontrolresource_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_customcontrolresource_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_customcontrolresource_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_customcontrolresource_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_customcontrolresource_modifiedby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_customcontrolresource_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_customcontrolresource_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_customcontrolresource_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_customcontrolresource_modifiedonbehalfby", null, value);
