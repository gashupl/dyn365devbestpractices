...
namespace Common.Entities
{
	...
	public partial class RelationshipRoleMap : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.AsyncOperation> RelationshipRoleMap_AsyncOperations
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.AsyncOperation>("RelationshipRoleMap_AsyncOperations", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("RelationshipRoleMap_AsyncOperations");
				this.SetRelatedEntities<Common.Entities.AsyncOperation>("RelationshipRoleMap_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.BulkDeleteFailure> RelationshipRoleMap_BulkDeleteFailures
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.BulkDeleteFailure>("RelationshipRoleMap_BulkDeleteFailures", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("RelationshipRoleMap_BulkDeleteFailures");
				this.SetRelatedEntities<Common.Entities.BulkDeleteFailure>("RelationshipRoleMap_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.UserEntityInstanceData> userentityinstancedata_relationshiprolemap
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_relationshiprolemap", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_relationshiprolemap");
				this.SetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_relationshiprolemap", null, value);
		...
		public Common.Entities.SystemUser createdby_relationship_role_map
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("createdby_relationship_role_map", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_relationshiprolemap_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_relationshiprolemap_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_relationshiprolemap_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_relationshiprolemap_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_relationshiprolemap_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_relationshiprolemap_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_relationshiprolemap_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_relationshiprolemap_modifiedonbehalfby", null, value);
		...
		public Common.Entities.SystemUser modifiedby_relationship_role_map
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("modifiedby_relationship_role_map", null);
			}
		}
		...
		public Common.Entities.RelationshipRole relationship_role_relationship_role_map
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.RelationshipRole>("relationship_role_relationship_role_map", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("relationship_role_relationship_role_map");
				this.SetRelatedEntity<Common.Entities.RelationshipRole>("relationship_role_relationship_role_map", null, value);
