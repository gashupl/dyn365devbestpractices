...
namespace Common.Entities
{
	...
	public partial class ReportVisibility : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.UserEntityInstanceData> userentityinstancedata_reportvisibility
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_reportvisibility", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_reportvisibility");
				this.SetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_reportvisibility", null, value);
		...
		public Common.Entities.SystemUser lk_reportvisibility_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_reportvisibility_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_reportvisibility_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_reportvisibility_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_reportvisibility_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_reportvisibility_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_reportvisibility_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_reportvisibility_modifiedonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_reportvisibilitybase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_reportvisibilitybase_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_reportvisibilitybase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_reportvisibilitybase_modifiedby", null);
			}
		}
		...
		public Common.Entities.Report report_reportvisibility
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.Report>("report_reportvisibility", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("report_reportvisibility");
				this.SetRelatedEntity<Common.Entities.Report>("report_reportvisibility", null, value);
