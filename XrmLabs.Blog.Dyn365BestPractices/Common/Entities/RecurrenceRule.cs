...
namespace Common.Entities
{
	...
	public partial class RecurrenceRule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.RecurringAppointmentMaster> recurrencerule_recurringappointmentmaster
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.RecurringAppointmentMaster>("recurrencerule_recurringappointmentmaster", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("recurrencerule_recurringappointmentmaster");
				this.SetRelatedEntities<Common.Entities.RecurringAppointmentMaster>("recurrencerule_recurringappointmentmaster", null, value);
		...
		public Common.Entities.ActivityPointer activity_pointer_recurrencerule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.ActivityPointer>("activity_pointer_recurrencerule", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("activity_pointer_recurrencerule");
				this.SetRelatedEntity<Common.Entities.ActivityPointer>("activity_pointer_recurrencerule", null, value);
		...
		public Common.Entities.BusinessUnit business_unit_recurrencerule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.BusinessUnit>("business_unit_recurrencerule", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_recurrencerule_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_recurrencerule_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_recurrencerule_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_recurrencerule_modifiedby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_recurrencerulebase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_recurrencerulebase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_recurrencerulebase_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_recurrencerulebase_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_recurrencerulebase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_recurrencerulebase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_recurrencerulebase_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_recurrencerulebase_modifiedonbehalfby", null, value);
