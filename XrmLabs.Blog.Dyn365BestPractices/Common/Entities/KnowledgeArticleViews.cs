...
namespace Common.Entities
{
	...
	public partial class KnowledgeArticleViews : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Common.Entities.KnowledgeArticleViewsState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Common.Entities.KnowledgeArticleViewsState)(System.Enum.ToObject(typeof(Common.Entities.KnowledgeArticleViewsState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.PrincipalObjectAttributeAccess> knowledgearticleview_principalobjectattributeaccess
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.PrincipalObjectAttributeAccess>("knowledgearticleview_principalobjectattributeaccess", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgearticleview_principalobjectattributeaccess");
				this.SetRelatedEntities<Common.Entities.PrincipalObjectAttributeAccess>("knowledgearticleview_principalobjectattributeaccess", null, value);
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.SyncError> KnowledgeArticleViews_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.SyncError>("KnowledgeArticleViews_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("KnowledgeArticleViews_SyncErrors");
				this.SetRelatedEntities<Common.Entities.SyncError>("KnowledgeArticleViews_SyncErrors", null, value);
		...
		public Common.Entities.KnowledgeArticle knowledgearticle_views
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.KnowledgeArticle>("knowledgearticle_views", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgearticle_views");
				this.SetRelatedEntity<Common.Entities.KnowledgeArticle>("knowledgearticle_views", null, value);
		...
		public Common.Entities.SystemUser lk_knowledgearticleviews_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_knowledgearticleviews_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_knowledgearticleviews_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_knowledgearticleviews_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_knowledgearticleviews_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_knowledgearticleviews_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_knowledgearticleviews_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_knowledgearticleviews_modifiedby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_knowledgearticleviews_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_knowledgearticleviews_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_knowledgearticleviews_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_knowledgearticleviews_modifiedonbehalfby", null, value);
		...
		public Common.Entities.TransactionCurrency transactioncurrency_knowledgearticleviews
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.TransactionCurrency>("transactioncurrency_knowledgearticleviews", null);
			}
		}
