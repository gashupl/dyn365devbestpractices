...
namespace Common.Entities
{
	...
	public partial class LookUpMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Common.Entities.LookUpMappingState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Common.Entities.LookUpMappingState)(System.Enum.ToObject(typeof(Common.Entities.LookUpMappingState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.UserEntityInstanceData> userentityinstancedata_lookupmapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_lookupmapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_lookupmapping");
				this.SetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_lookupmapping", null, value);
		...
		public Common.Entities.SystemUser lk_lookupmapping_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_lookupmapping_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_lookupmapping_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_lookupmapping_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_lookupmapping_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_lookupmapping_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_lookupmapping_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_lookupmapping_modifiedby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_lookupmapping_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_lookupmapping_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_lookupmapping_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_lookupmapping_modifiedonbehalfby", null, value);
		...
		public Common.Entities.ColumnMapping LookUpMapping_ColumnMapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.ColumnMapping>("LookUpMapping_ColumnMapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("LookUpMapping_ColumnMapping");
				this.SetRelatedEntity<Common.Entities.ColumnMapping>("LookUpMapping_ColumnMapping", null, value);
		...
		public Common.Entities.TransformationParameterMapping LookUpMapping_TransformationParameterMapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.TransformationParameterMapping>("LookUpMapping_TransformationParameterMapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("LookUpMapping_TransformationParameterMapping");
				this.SetRelatedEntity<Common.Entities.TransformationParameterMapping>("LookUpMapping_TransformationParameterMapping", null, value);
