...
namespace Common.Entities
{
	...
	public partial class PublisherAddress : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.UserEntityInstanceData> userentityinstancedata_publisheraddress
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_publisheraddress", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_publisheraddress");
				this.SetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_publisheraddress", null, value);
		...
		public Common.Entities.SystemUser lk_publisheraddressbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_publisheraddressbase_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_publisheraddressbase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_publisheraddressbase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_publisheraddressbase_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_publisheraddressbase_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_publisheraddressbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_publisheraddressbase_modifiedby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_publisheraddressbase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_publisheraddressbase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_publisheraddressbase_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_publisheraddressbase_modifiedonbehalfby", null, value);
		...
		public Common.Entities.Publisher Publisher_PublisherAddress
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.Publisher>("Publisher_PublisherAddress", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Publisher_PublisherAddress");
				this.SetRelatedEntity<Common.Entities.Publisher>("Publisher_PublisherAddress", null, value);
