...
namespace Common.Entities
{
	...
	public partial class OfficeGraphDocument : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Common.Entities.SystemUser lk_officegraphdocument_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_officegraphdocument_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_officegraphdocument_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_officegraphdocument_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_officegraphdocument_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_officegraphdocument_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_officegraphdocument_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_officegraphdocument_modifiedonbehalfby", null, value);
		...
		public Common.Entities.Organization organization_officegraphdocument
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.Organization>("organization_officegraphdocument", null);
			}
		}
		...
		public Common.Entities.TransactionCurrency TransactionCurrency_officegraphdocument
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.TransactionCurrency>("TransactionCurrency_officegraphdocument", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_officegraphdocument");
				this.SetRelatedEntity<Common.Entities.TransactionCurrency>("TransactionCurrency_officegraphdocument", null, value);
