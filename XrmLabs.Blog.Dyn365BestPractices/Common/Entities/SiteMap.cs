...
namespace Common.Entities
{
	...
	public partial class SiteMap : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.UserEntityInstanceData> userentityinstancedata_sitemap
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_sitemap", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_sitemap");
				this.SetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_sitemap", null, value);
		...
		public Common.Entities.SystemUser lk_SiteMap_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_SiteMap_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_SiteMap_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_SiteMap_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_SiteMap_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_SiteMap_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_SiteMap_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_SiteMap_modifiedby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_SiteMap_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_SiteMap_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_SiteMap_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_SiteMap_modifiedonbehalfby", null, value);
		...
		public Common.Entities.Organization organization_sitemap
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.Organization>("organization_sitemap", null);
			}
		}
