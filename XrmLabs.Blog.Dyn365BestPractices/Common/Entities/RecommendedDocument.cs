...
namespace Common.Entities
{
	...
	public partial class RecommendedDocument : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Common.Entities.SystemUser lk_recommendeddocument_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_recommendeddocument_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_recommendeddocument_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_recommendeddocument_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_recommendeddocument_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_recommendeddocument_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_recommendeddocument_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_recommendeddocument_modifiedby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_recommendeddocument_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_recommendeddocument_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_recommendeddocument_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_recommendeddocument_modifiedonbehalfby", null, value);
		...
		public Common.Entities.Organization organization_recommendeddocument
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.Organization>("organization_recommendeddocument", null);
			}
		}
		...
		public Common.Entities.TransactionCurrency TransactionCurrency_recommendeddocument
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.TransactionCurrency>("TransactionCurrency_recommendeddocument", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_recommendeddocument");
				this.SetRelatedEntity<Common.Entities.TransactionCurrency>("TransactionCurrency_recommendeddocument", null, value);
