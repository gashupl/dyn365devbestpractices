...
namespace Common.Entities
{
	...
	public partial class AppConfig : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Common.Entities.AppConfigState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Common.Entities.AppConfigState)(System.Enum.ToObject(typeof(Common.Entities.AppConfigState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.AppConfigInstance> appconfig_appconfiginstance
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.AppConfigInstance>("appconfig_appconfiginstance", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("appconfig_appconfiginstance");
				this.SetRelatedEntities<Common.Entities.AppConfigInstance>("appconfig_appconfiginstance", null, value);
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.NavigationSetting> navigationsetting_appconfig
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.NavigationSetting>("navigationsetting_appconfig", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("navigationsetting_appconfig");
				this.SetRelatedEntities<Common.Entities.NavigationSetting>("navigationsetting_appconfig", null, value);
		...
		public Common.Entities.AppModule appmodule_appconfig
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.AppModule>("appmodule_appconfig", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("appmodule_appconfig");
				this.SetRelatedEntity<Common.Entities.AppModule>("appmodule_appconfig", null, value);
		...
		public Common.Entities.SystemUser lk_appconfig_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_appconfig_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_appconfig_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_appconfig_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appconfig_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_appconfig_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_appconfig_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_appconfig_modifiedby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_appconfig_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_appconfig_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appconfig_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_appconfig_modifiedonbehalfby", null, value);
		...
		public Common.Entities.Organization organization_appconfig
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.Organization>("organization_appconfig", null);
			}
		}
