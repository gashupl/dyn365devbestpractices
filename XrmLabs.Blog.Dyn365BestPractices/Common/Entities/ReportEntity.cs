...
namespace Common.Entities
{
	...
	public partial class ReportEntity : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.UserEntityInstanceData> userentityinstancedata_reportentity
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_reportentity", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_reportentity");
				this.SetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_reportentity", null, value);
		...
		public Common.Entities.SystemUser lk_reportentity_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_reportentity_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_reportentity_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_reportentity_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_reportentity_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_reportentity_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_reportentity_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_reportentity_modifiedonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_reportentitybase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_reportentitybase_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_reportentitybase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_reportentitybase_modifiedby", null);
			}
		}
		...
		public Common.Entities.Report report_reportentities
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.Report>("report_reportentities", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("report_reportentities");
				this.SetRelatedEntity<Common.Entities.Report>("report_reportentities", null, value);
