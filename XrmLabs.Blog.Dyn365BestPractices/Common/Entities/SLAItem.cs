...
namespace Common.Entities
{
	...
	public partial class SLAItem : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.SyncError> SLAItem_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.SyncError>("SLAItem_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("SLAItem_SyncErrors");
				this.SetRelatedEntities<Common.Entities.SyncError>("SLAItem_SyncErrors", null, value);
		...
		public Common.Entities.SystemUser lk_slaitembase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_slaitembase_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_slaitembase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_slaitembase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_slaitembase_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_slaitembase_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_slaitembase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_slaitembase_modifiedby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_slaitembase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_slaitembase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_slaitembase_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_slaitembase_modifiedonbehalfby", null, value);
		...
		public Common.Entities.SLA sla_slaitem_slaId
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SLA>("sla_slaitem_slaId", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sla_slaitem_slaId");
				this.SetRelatedEntity<Common.Entities.SLA>("sla_slaitem_slaId", null, value);
		...
		public Common.Entities.Workflow slaitembase_workflowid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.Workflow>("slaitembase_workflowid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("slaitembase_workflowid");
				this.SetRelatedEntity<Common.Entities.Workflow>("slaitembase_workflowid", null, value);
		...
		public Common.Entities.TransactionCurrency TransactionCurrency_SLAItem
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.TransactionCurrency>("TransactionCurrency_SLAItem", null);
			}
		}
