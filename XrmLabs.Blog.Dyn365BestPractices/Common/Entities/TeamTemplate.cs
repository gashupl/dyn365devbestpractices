...
namespace Common.Entities
{
	...
	public partial class TeamTemplate : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.SyncError> TeamTemplate_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.SyncError>("TeamTemplate_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TeamTemplate_SyncErrors");
				this.SetRelatedEntities<Common.Entities.SyncError>("TeamTemplate_SyncErrors", null, value);
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.Team> teamtemplate_Teams
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.Team>("teamtemplate_Teams", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("teamtemplate_Teams");
				this.SetRelatedEntities<Common.Entities.Team>("teamtemplate_Teams", null, value);
		...
		public Common.Entities.SystemUser lk_teamtemplate_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_teamtemplate_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_teamtemplate_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_teamtemplate_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_teamtemplate_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_teamtemplate_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_teamtemplate_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_teamtemplate_modifiedby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_teamtemplate_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_teamtemplate_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_teamtemplate_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_teamtemplate_modifiedonbehalfby", null, value);
