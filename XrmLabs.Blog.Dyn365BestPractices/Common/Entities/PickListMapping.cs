...
namespace Common.Entities
{
	...
	public partial class PickListMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Common.Entities.PickListMappingState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Common.Entities.PickListMappingState)(System.Enum.ToObject(typeof(Common.Entities.PickListMappingState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.UserEntityInstanceData> userentityinstancedata_picklistmapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_picklistmapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_picklistmapping");
				this.SetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_picklistmapping", null, value);
		...
		public Common.Entities.SystemUser lk_picklistmapping_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_picklistmapping_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_picklistmapping_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_picklistmapping_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_picklistmapping_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_picklistmapping_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_picklistmapping_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_picklistmapping_modifiedby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_picklistmapping_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_picklistmapping_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_picklistmapping_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_picklistmapping_modifiedonbehalfby", null, value);
		...
		public Common.Entities.ColumnMapping PickListMapping_ColumnMapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.ColumnMapping>("PickListMapping_ColumnMapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("PickListMapping_ColumnMapping");
				this.SetRelatedEntity<Common.Entities.ColumnMapping>("PickListMapping_ColumnMapping", null, value);
