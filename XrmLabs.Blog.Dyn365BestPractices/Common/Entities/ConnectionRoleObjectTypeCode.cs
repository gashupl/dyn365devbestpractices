...
namespace Common.Entities
{
	...
	public partial class ConnectionRoleObjectTypeCode : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.UserEntityInstanceData> userentityinstancedata_connectionroleobjecttypecode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_connectionroleobjecttypecode", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_connectionroleobjecttypecode");
				this.SetRelatedEntities<Common.Entities.UserEntityInstanceData>("userentityinstancedata_connectionroleobjecttypecode", null, value);
		...
		public Common.Entities.ConnectionRole connection_role_connection_role_object_type_codes
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.ConnectionRole>("connection_role_connection_role_object_type_codes", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("connection_role_connection_role_object_type_codes");
				this.SetRelatedEntity<Common.Entities.ConnectionRole>("connection_role_connection_role_object_type_codes", null, value);
