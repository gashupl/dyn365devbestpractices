...
namespace Common.Entities
{
	...
	public partial class AppModuleComponent : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Common.Entities.AppModule appmodule_appmodulecomponent
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.AppModule>("appmodule_appmodulecomponent", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("appmodule_appmodulecomponent");
				this.SetRelatedEntity<Common.Entities.AppModule>("appmodule_appmodulecomponent", null, value);
		...
		public Common.Entities.SystemUser lk_appmodulecomponent_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_appmodulecomponent_createdby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_appmodulecomponent_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_appmodulecomponent_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appmodulecomponent_createdonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_appmodulecomponent_createdonbehalfby", null, value);
		...
		public Common.Entities.SystemUser lk_appmodulecomponent_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_appmodulecomponent_modifiedby", null);
			}
		}
		...
		public Common.Entities.SystemUser lk_appmodulecomponent_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Common.Entities.SystemUser>("lk_appmodulecomponent_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appmodulecomponent_modifiedonbehalfby");
				this.SetRelatedEntity<Common.Entities.SystemUser>("lk_appmodulecomponent_modifiedonbehalfby", null, value);
