...
namespace Common.Entities
{
	...
	public partial class EntitlementTemplateProducts : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.AsyncOperation> entitlementtemplateproducts_AsyncOperations
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.AsyncOperation>("entitlementtemplateproducts_AsyncOperations", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("entitlementtemplateproducts_AsyncOperations");
				this.SetRelatedEntities<Common.Entities.AsyncOperation>("entitlementtemplateproducts_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.BulkDeleteFailure> entitlementtemplateproducts_BulkDeleteFailures
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.BulkDeleteFailure>("entitlementtemplateproducts_BulkDeleteFailures", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("entitlementtemplateproducts_BulkDeleteFailures");
				this.SetRelatedEntities<Common.Entities.BulkDeleteFailure>("entitlementtemplateproducts_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.MailboxTrackingFolder> entitlementtemplateproducts_MailboxTrackingFolders
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.MailboxTrackingFolder>("entitlementtemplateproducts_MailboxTrackingFolders", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("entitlementtemplateproducts_MailboxTrackingFolders");
				this.SetRelatedEntities<Common.Entities.MailboxTrackingFolder>("entitlementtemplateproducts_MailboxTrackingFolders", null, value);
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.PrincipalObjectAttributeAccess> entitlementtemplateproducts_PrincipalObjectAttributeAccesses
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.PrincipalObjectAttributeAccess>("entitlementtemplateproducts_PrincipalObjectAttributeAccesses", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("entitlementtemplateproducts_PrincipalObjectAttributeAccesses");
				this.SetRelatedEntities<Common.Entities.PrincipalObjectAttributeAccess>("entitlementtemplateproducts_PrincipalObjectAttributeAccesses", null, value);
		...
		public System.Collections.Generic.IEnumerable<Common.Entities.UserEntityInstanceData> entitlementtemplateproducts_UserEntityInstanceDatas
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Common.Entities.UserEntityInstanceData>("entitlementtemplateproducts_UserEntityInstanceDatas", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("entitlementtemplateproducts_UserEntityInstanceDatas");
				this.SetRelatedEntities<Common.Entities.UserEntityInstanceData>("entitlementtemplateproducts_UserEntityInstanceDatas", null, value);
